...
public class ReceiptController implements Initializable {
    ...
    private void ReceeiptSave_onAct(ActionEvent event) {
       ...
       ReceiptTM receipt=new ReceiptTM(txtReceiptId.getText(), cmbpatientID.getValue(), cmbpid.getValue(), cmbmid.getValue(), UnitPrice, Total, Qty, Date.valueOf(txtdate.getValue()));
    ...
    public  void Save(){
        try {
            BigDecimal UnitPrice=new BigDecimal(txtUnitprice.getText());
            int Qty=Integer.parseInt(txtQty.getText());
            ReceiptDTO rece=new ReceiptDTO(txtReceiptId.getText(), cmbpatientID.getValue(), cmbpid.getValue(), cmbmid.getValue(),UnitPrice,Qty, Date.valueOf(txtdate.getValue()));
   ...
   public  void updatereceipt(){
    ...
    private void GenerateOnAct(ActionEvent event) {
        ...
        try {
            JasperPrint fillReport=JasperFillManager.fillReport(resourseInputStream, map,DBConnection.getInstance().getConnection());
